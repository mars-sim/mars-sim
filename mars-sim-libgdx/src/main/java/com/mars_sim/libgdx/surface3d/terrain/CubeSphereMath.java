...
public final class CubeSphereMath {
    ...
    public static Vector3 faceVector(int face, float u, float v, Vector3 out) {
        switch (face) {
            case 0: return out.set( 1f,   v,  -u); // +X
            case 1: return out.set(-1f,   v,   u); // -X
            case 2: return out.set(  u,  1f,  -v); // +Y
            case 3: return out.set(  u, -1f,   v); // -Y
            case 4: return out.set(  u,   v,  1f); // +Z
            default:return out.set( -u,   v, -1f); // -Z
        }
    }
    ...
    public static void tileUvRange(TileKey key, float[] outUV) {
        ...
        float u1 = u0 + span;
        float v1 = v0 + span;
        outUV[0] = u0; outUV[1] = v0; outUV[2] = u1; outUV[3] = v1;
    }
}

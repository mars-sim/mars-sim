...
public class OutputDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public OutputDescriptor() {
        ...
        //-- _rate
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Double.TYPE, "_rate", "rate", org.exolab.castor.xml.NodeType.Attribute);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Output target = (Output) object;
                if (!target.hasRate()) { return null; }
                return new java.lang.Double(target.getRate());
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    target.setRate( ((java.lang.Double) value).doubleValue());
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
        ...
        desc.setValidator(fieldValidator);
        //-- _ambient
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(java.lang.Boolean.TYPE, "_ambient", "ambient", org.exolab.castor.xml.NodeType.Attribute);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                Output target = (Output) object;
                if (!target.hasAmbient()) { return null; }
                return (target.getAmbient() ? java.lang.Boolean.TRUE : java.lang.Boolean.FALSE);
            }
            @Override
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    ...
                    // if null, use delete method for optional primitives 
                    if (value == null) {
                        target.deleteAmbient();
                        return;
                    }
                    target.setAmbient( ((java.lang.Boolean) value).booleanValue());
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.mars_sim.msp.config.model.building.Output.class;
    }

...
public class MedicalComplaintList implements java.io.Serializable {
     ...
     */
    private java.util.List<org.mars_sim.msp.config.model.medical.MedicalComplaint> _medicalComplaintList;
    ...
    public MedicalComplaintList() {
        super();
        this._medicalComplaintList = new java.util.ArrayList<org.mars_sim.msp.config.model.medical.MedicalComplaint>();
    }
    ...
    public void addMedicalComplaint(
            final org.mars_sim.msp.config.model.medical.MedicalComplaint vMedicalComplaint)
     ...
     * collection
     */
    public java.util.Enumeration<? extends org.mars_sim.msp.config.model.medical.MedicalComplaint> enumerateMedicalComplaint(
    ) {
     ...
     * org.mars_sim.msp.config.model.medical.MedicalComplaint at
     * the given index
     */
    public org.mars_sim.msp.config.model.medical.MedicalComplaint getMedicalComplaint(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.mars_sim.msp.config.model.medical.MedicalComplaint) _medicalComplaintList.get(index);
    }
    ...
    public org.mars_sim.msp.config.model.medical.MedicalComplaint[] getMedicalComplaint(
        ...
        org.mars_sim.msp.config.model.medical.MedicalComplaint[] array = new org.mars_sim.msp.config.model.medical.MedicalComplaint[0];
        return (org.mars_sim.msp.config.model.medical.MedicalComplaint[]) this._medicalComplaintList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<? extends org.mars_sim.msp.config.model.medical.MedicalComplaint> iterateMedicalComplaint(
    ) {
     ...
     */
    public org.mars_sim.msp.config.model.medical.MedicalComplaint removeMedicalComplaintAt(
            final int index) {
        java.lang.Object obj = this._medicalComplaintList.remove(index);
        return (org.mars_sim.msp.config.model.medical.MedicalComplaint) obj;
    }
     ...
     */
    public void setMedicalComplaint(
            final org.mars_sim.msp.config.model.medical.MedicalComplaint[] vMedicalComplaintArray) {
        //-- copy array
     ...
     * org.mars_sim.msp.config.model.medical.MedicalComplaintList
     */
    public static org.mars_sim.msp.config.model.medical.MedicalComplaintList unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.mars_sim.msp.config.model.medical.MedicalComplaintList) org.exolab.castor.xml.Unmarshaller.unmarshal(org.mars_sim.msp.config.model.medical.MedicalComplaintList.class, reader);
    }

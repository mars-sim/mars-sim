...
implements Serializable {
    ...
    public static double getProbability(Person person) {
        ...
        if (person.getLocationSituation() == LocationSituation.IN_SETTLEMENT) {
            ...
            try {
                List<BuildingConstructionMission> missions = getAllMissionsNeedingAssistance(
     ...
     */
    private static List<BuildingConstructionMission> getAllMissionsNeedingAssistance(

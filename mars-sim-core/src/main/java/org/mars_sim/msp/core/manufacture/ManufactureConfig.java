    ...
    List<SalvageProcessInfo> getSalvageList() {
        ...
        if (salvageList == null) {
            ...
            while (i.hasNext()) {
                ...
                salvage.setWorkTimeRequired(Double.parseDouble(salvageElement
                        .getAttributeValue(WORK_TIME)));

                List<Element> partSalvageNodes = salvageElement
                        .getChildren(PART_SALVAGE);
                List<PartSalvage> partSalvageList = new ArrayList<PartSalvage>(
                        partSalvageNodes.size());
                ...
                while (j.hasNext()) {
                    ...
                    part.setNumber(Integer.parseInt(partSalvageElement
                            .getAttributeValue(NUMBER)));
                }
            }
        }

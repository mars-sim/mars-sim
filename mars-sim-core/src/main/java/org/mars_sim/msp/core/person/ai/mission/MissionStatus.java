...
public enum MissionStatus {
	...
	CONSTRUCTION_SITE_NOT_FOUND_OR_CREATED			("Construction site could not be found or created."),
	...
	SALVAGE_CONSTRUCTION_STAGE_NOT_FOUND			("Salvage construction stage not be found."),
	...
	CONSTRUCTION_ATTACHMENT_PART_NOT_RETRIEVED		("Construction attachment part could not be retrieved."),
	...
	SELLING_VEHICLE_NOT_AVAILABLE_FOR_TRADE			("Selling vehicle is not available for trade."),

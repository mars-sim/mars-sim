...
import org.mars_sim.msp.core.person.ai.task.meta.MaintainBuildingEVAMeta;
...
import org.mars_sim.msp.core.person.ai.task.meta.RepairInsideMalfunctionMeta;
...
public class MetaTaskUtil {
	...
	public static synchronized void initializeMetaTasks() {
		...
		allMetaTasks.add(new MaintainBuildingEVAMeta());
		...
		allMetaTasks.add(new RepairInsideMalfunctionMeta());

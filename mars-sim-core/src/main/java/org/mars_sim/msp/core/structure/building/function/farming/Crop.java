...
public class Crop implements Serializable {
	...
	public static final double FERTILIZER_NEEDED_WATERING = 0.00005D;  // a very minute amount needed per unit time, called if grey water is not available
		...
		if (!isStartup) {
			...
			if (tissuePercent <= 0) {
				...
				LogConsolidated.log(logger, Level.INFO, 10000, sourceName, 
						"[" + settlement + "] " 
						+ " No " + capitalizedCropName 
						+ " tissue culture left in " + farmName
						+ " Will need to restock via incubation in " 
						+ farmName + ".", null);
			}

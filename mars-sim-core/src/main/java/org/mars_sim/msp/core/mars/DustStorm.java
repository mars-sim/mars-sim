...
*/
	...
	public DustStorm(String name, DustStormType type, int id, MarsClock marsClock, Weather weather, List<Settlement> settlements) {
...
*/
			...
			for (Settlement s : settlements) {
				mean_pressure = (mean_pressure + weather.calculateAirPressure(settlements.get(0).getCoordinates(), HEIGHT))/2D;
	...
	public int computeNewSize() {
		...
		// 10 times larger than any tornado on Earth. Red-brown sand and dust whipping around faster than 30 meters per second

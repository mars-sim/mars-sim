/*
 *  $Id: SingletonEdgeCollection.java,v 1.4 2005/10/03 15:20:46 rconner Exp $
 *
...
/**
 *  A singleton edge <code>Collection</code> view.  Since this
...
public class SingletonEdgeCollection extends AbstractSingletonCollection
{
    ...
    /**
     *  Creates a new <code>SingletonEdgeCollection</code>.
     */
    ...
    {
        return !graph.containsEdge( (Graph.Edge) getElement() );
    }


    public boolean removeElement()
    {
        return graph.removeEdge( (Graph.Edge) getElement() );
    }

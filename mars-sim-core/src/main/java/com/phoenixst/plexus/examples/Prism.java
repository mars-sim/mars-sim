/*
 *  $Id: Prism.java,v 1.10 2006/06/07 19:56:36 rconner Exp $
 *
...
/**
 *  An <code>m x n</code> prism, where <code>m</code> is the size of
 *  the cycle and <code>n</code> is the size of the path.  This graph
...
public class Prism extends Product
{
    ...
    /**
     *  Creates a new <code>Prism</code>.
     */
    public Prism( int m, int n )
    {
        super( new Cycle( m ),
               new Path( n ) );
        this.m = m;

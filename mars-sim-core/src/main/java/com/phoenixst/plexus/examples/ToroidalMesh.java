/*
 *  $Id: ToroidalMesh.java,v 1.10 2006/06/07 19:56:36 rconner Exp $
 *
...
/**
 *  An <code>m x n</code> toroidal mesh.
 *
...
public class ToroidalMesh extends Product
{
    ...
    /**
     *  Creates a new <code>ToroidalMesh</code>.
     */
    public ToroidalMesh( int m, int n )
    {
        super( new Cycle( m ),
               new Cycle( n ) );
        this.m = m;

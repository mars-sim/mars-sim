/*
 *  $Id: Wheel.java,v 1.12 2006/06/07 19:56:36 rconner Exp $
 *
...
/**
 *  A wheel graph with one central node and <code>n</code> outer
 *  nodes.
 *
 ...
 *  @since      1.0
 */
public class Wheel extends Join
{
    ...
    /**
     *  Creates a new <code>Wheel</code>.
     */
    public Wheel( int n )
    {
        super( new EmptyGraph( 1 ),
               new GraphTransformer( new Cycle( n ),

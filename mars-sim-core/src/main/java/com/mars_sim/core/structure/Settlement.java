...
//			}
//			
//			int newSkill = (int)Math.round(skill / (0.1 + num));
//	
//			double limit = 200 + (range - 200) * Math.min(100, sol) / 100;
//			
...
//// 	     			else {
//// 	     				logger.info(this, "Could not zone up a ROI.");
//// 	     			}
// 				}
// 			}
// 			else {
...
//		LinkedHashMap<String, Integer> sortedMap = nearbyMineralLocations.entrySet()
//			    .stream()

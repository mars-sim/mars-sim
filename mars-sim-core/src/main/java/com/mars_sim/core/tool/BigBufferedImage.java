...
/**
 * References: 
 * 1. https://stackoverflow.com/questions/3854200/why-does-a-bufferedimage-require-so-much-memory-beyond-the-size-of-its-data-arra/53205617#53205617
 * 2. https://stackoverflow.com/questions/37517978/read-and-write-a-large-image/37552223#37552223
 * 
 */
...
/**
 * BigBufferedImage can load and store much larger images than the memory limit. 
 * The trick is that its buffer is replaced with a file based implementation of 
 * DataBuffer. It stores the image on the hard drive. No RAM is used. 
 * This can prevent OutOfMemoryException.
 */

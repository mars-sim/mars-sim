...
import com.mars_sim.core.building.function.farming.task.TendGreenhouseMeta;
...
import com.mars_sim.core.data.collection.task.GatherGroundDataMeta;
...
import com.mars_sim.core.mission.task.PlanMissionMeta;
import com.mars_sim.core.mission.task.ReviewMissionPlanMeta;
...
public class MetaTaskUtil {
	...
	public static synchronized void initializeMetaTasks() {
		...
		allMetaTasks.add(new GatherGroundDataMeta());

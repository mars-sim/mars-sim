...
public class TestGoods extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        hammer = ItemResourceUtil.createItemResource("hammer", 1100, "a hand tool", "tool", 1.4D, 1);
//        goodsList = GoodsUtil.getGoodsList();
    }

    public void testCreateItem() {
    	Part microlens = ItemResourceUtil.createItemResource("microlens", 1102, "a test lense", "instrument", 0.05D, 1);
    }

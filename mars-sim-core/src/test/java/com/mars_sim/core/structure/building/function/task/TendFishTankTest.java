...
public class TendFishTankTest extends AbstractMarsSimUnitTest {
    ...
    public void testPersonFishing() {
        ...
        assertTrue("Fish meat created", s.getAmountResourceStored(ResourceUtil.fishMeatID) >0D);
        assertTrue("Fish oil created", s.getAmountResourceStored(ResourceUtil.fishOilID) >0D);

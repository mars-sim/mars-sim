...
class MedicalConfigTest {
    ...
    void testDehydrationComplaint() {
        ...
        var found = medConfig.getComplaintByName("DEHYDRATION");
    ...
    void testAppendicitisComplaint() {
        ...
        var found = medConfig.getComplaintByName("APPENDICITIS");
        ...
        assertEquals("RUPTURED_APPENDIX", found.getNextPhase().getType(), "Next complaint");
    }
    ...
    void testBurnsComplaint() {
        ...
        var found = medConfig.getComplaintByName("BURNS");

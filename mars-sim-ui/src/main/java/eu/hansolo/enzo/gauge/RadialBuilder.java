...
public class RadialBuilder<B extends RadialBuilder<B>> {
    ...
    // ******************** Methods *******************************************
    public static final RadialBuilder create() {
    ...
    public final B lcdVisible(final boolean LCD_VISIBLE) {
    ...
    public final B tickLabelOrientation(final Radial.TickLabelOrientation TICK_LABEL_ORIENTATION) {
        properties.put("tickLabelOrientation", new SimpleObjectProperty<>(TICK_LABEL_ORIENTATION));
        return (B)this;
    }

    public final B numberFormat(final Radial.NumberFormat NUMBER_FORMAT) {
    ...
    public final B frameSizeFactor(final double FRAME_SIZE_FACTOR) {
        properties.put("frameSizeFactor", new SimpleDoubleProperty(FRAME_SIZE_FACTOR));
        return (B)this;
    }

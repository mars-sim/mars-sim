...
set SOURCE=%SOURCE% ..\org\mars_sim\msp\simulation\person\ai\job\*.java
set SOURCE=%SOURCE% ..\org\mars_sim\msp\simulation\person\ai\mission\*.java
set SOURCE=%SOURCE% ..\org\mars_sim\msp\simulation\person\ai\social\*.java
...
set SOURCE=%SOURCE% ..\org\mars_sim\msp\ui\standard\sound\*.java

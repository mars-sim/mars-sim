...
set PACKAGES=%PACKAGES% org.mars_sim.msp.simulation.person.ai.job
set PACKAGES=%PACKAGES% org.mars_sim.msp.simulation.person.ai.mission
set PACKAGES=%PACKAGES% org.mars_sim.msp.simulation.person.ai.social
...
set PACKAGES=%PACKAGES% org.mars_sim.msp.ui.standard.sound
...
cd ../
javadoc -classpath .;jars\jfreechart.jar;jars\jcommon.jar;jars\junit.jar;jars\plexus-core.jar;jars\commons-collections-3.1.jar;jars\log4j-1.2.8.jar -d docs/javadoc -overview overview.html -use -author -windowtitle "Mars Simulation Project v 2.79 API Specification" -doctitle "Mars Simulation Project v 2.79<BR>API Specification" -header "<b>Mars Simulation Project</b><br><font size=\"-1\">v2.79</font>" %PACKAGES%
cd scripts

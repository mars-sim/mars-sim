...
import org.mars_sim.msp.config.model.medical.TreatmentTime;

/**
 * Class TreatmentTimeDescriptor.
 * 
 * @version $Revision$ $Date$
 */
public class TreatmentTimeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public TreatmentTimeDescriptor() {
        super();
        _nsURI = "http://mars-sim.sourceforge.net/medical";
        _xmlName = "treatment-time";
        ...
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                TreatmentTime target = (TreatmentTime) object;
    ...
    public java.lang.Class getJavaClass(
        ...
        return org.mars_sim.msp.config.model.medical.TreatmentTime.class;
    }

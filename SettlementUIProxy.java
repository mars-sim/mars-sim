...
public class SettlementUIProxy extends UnitUIProxy {
    ...
    private static ImageIcon surfMapIcon = new ImageIcon("SettlementSymbol.gif");
    private static ImageIcon topoMapIcon = new ImageIcon("SettlementSymbolBlack.gif");
    private static Font mapLabelFont = new Font("Helvetica", Font.PLAIN, 12);
    private static ImageIcon buttonIcon = new ImageIcon("SettlementIcon.gif");

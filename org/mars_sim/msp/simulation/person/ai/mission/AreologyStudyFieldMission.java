...
import org.mars_sim.msp.simulation.person.ai.task.AreologyStudyFieldWork;
...
public class AreologyStudyFieldMission extends RoverMission implements Serializable {
            ...
            if (reservableRover && backupRover && minNum && !embarkingMissions && hasBasicResources 
                ...
                try {
                    ...
                    if (rover != null) {
                        ...
                        Science areology = ScienceUtil.getScience(Science.AREOLOGY);
                        ...
                        if ((primaryStudy != null) && ScientificStudy.RESEARCH_PHASE.equals(primaryStudy.getPhase())) {
                            if (!primaryStudy.isPrimaryResearchCompleted()) {
                                if (areology.equals(primaryStudy.getScience())) 
                                    result += 10D;
                            }
                        }
                        ...
                        while (i.hasNext()) {
                            ...
                            if (ScientificStudy.RESEARCH_PHASE.equals(collabStudy.getPhase())) {
                                if (!collabStudy.isCollaborativeResearchCompleted(person)) {
                                    if (areology.equals(collabStudy.getCollaborativeResearchers().get(person)))
                                        result += 5D;
                                }
                            }
                        }
    ...
    private ScientificStudy determineStudy(Person researcher) {
        ...
        while (i.hasNext()) {
            ...
            if (ScientificStudy.RESEARCH_PHASE.equals(collabStudy.getPhase()) && 
                ...
                if (areology.equals(collabStudy.getCollaborativeResearchers().get(researcher)))
        ...
        if (isCapableOfMission(person)) {
            ...
            if (study != null) {
                if (person == study.getPrimaryResearcher()) {
                    ...
                    if (areology.equals(study.getScience())) result += 1D;
                }
                    ...
                    if (areology.equals(collabScience)) result += 1D;
                }
            }
        }
    ...
    public void endResearchAtFieldSite() {
        ...
        while (i.hasNext()) {
            ...
            if (task instanceof AreologyStudyFieldWork) ((AreologyStudyFieldWork) task).endEVA();
        }
    }
    ...
    private final void researchFieldSitePhase(Person person) throws MissionException {
        ...
        if (isEveryoneInRover()) {
            ...
            while (j.hasNext()) {
                if (AreologyStudyFieldWork.canResearchSite(j.next(), getRover())) nobodyFieldWork = false;
            }

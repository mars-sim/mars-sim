...
public abstract class ResearchScience extends Task implements Serializable {
	 ...
	 */
	public ResearchScience(String science, Person person) throws Exception {
	 ...
	 */
	protected static Lab getLocalLab(Person person, String science) throws Exception {
		Lab result = null;
	...
	public int getEffectiveSkillLevel() {
		...
		return manager.getEffectiveSkillLevel(science);
	}  

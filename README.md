...
Player may create numerous settlements spreading across the surface of Mars. Each settlement has a *[command structure](https://github.com/mars-sim/mars-sim/wiki/Role)* and a *[development objective](https://github.com/mars-sim/mars-sim/wiki/Settlement-Objective)*. As mars-sim loosely follows the *Mars Direct Mission Plan by Robert Zubrin*, a simple 4-person initial base is called a MDP Phase 1, a trading outpost, a mining depot near sites with high mineral concentration; or a self-contained colony with 48+ settlers having an elected mayor. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwOTkxODAyNDJdfQ==
-->
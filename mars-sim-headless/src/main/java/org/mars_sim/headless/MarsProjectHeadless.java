...
/**
 * MarsProjectHeadless is the main class for starting mars-sim in purely headless mode.
 */
...
//                showError("Could not load the default simulation, trying to create a new Simulation...", e);
    ...
    private void handleLoadDefaultSimulation() throws Exception {
		//logger.info("handleLoadDefaultSimulation() is on "+Thread.currentThread().getName() + " Thread");
    ...
    public static void main(String [] args) throws IOException, InterruptedException, URISyntaxException{
        ...
        try {
            LogManager.getLogManager().readConfiguration(MarsProjectHeadless.class.getResourceAsStream("/logging.properties"));
        } catch (IOException e) {
